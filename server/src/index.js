...
app.post("/create", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            // });
            // await newNote.save();
            return [4 /*yield*/, node_1.default.create({
...
app.patch("/:noteId", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var noteId, note, _a, title, description;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                noteId = req.params.noteId;
                return [4 /*yield*/, node_1.default.findById(noteId)];
            case 1:
                note = _b.sent();
                if (!note)
                    return [2 /*return*/, res.json({ error: "Note not found!" })];
